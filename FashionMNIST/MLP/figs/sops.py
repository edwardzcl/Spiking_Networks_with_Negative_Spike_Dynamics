...
## the number of MAC of MLP on FashionMNIST, a multiplication is supposed to be equivalent with two additions in this paper
mac0 = (400*400 + 400*10)*3
mac1 = mac0
mac2 = mac0
...
plt.savefig('smlp_sop_fashionmnist.svg',format='svg')
