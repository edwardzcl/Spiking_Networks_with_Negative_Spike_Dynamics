...
@author: ***
Training script for spiking LeNet with quantization level k=2 on FashionMNIST.
"""
   ...
   for epoch in range(n_epoch):
       ...
       if epoch + 1 == 1 or (epoch + 1) % print_freq == 0:
           ...
           if (epoch + 1) % (print_freq) == 0:
               ...
               tl.files.save_npz(net_train.all_params, name='model_fashion_mnist.npz', sess=sess)
