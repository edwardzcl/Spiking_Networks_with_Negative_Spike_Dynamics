...
class MyNet():
    def __init__(self):
        ...
        self.conv1 = Conv2d(in_channels=1, n_filter=32, filter_size=(5, 5), padding=0, stride=1, use_ternary=False)   
        self.bn1 = BatchNorm2d(n_channel=32, momentum=0.1)
        self.relu1 = Relu()
        
        self.conv2 = Conv2d(in_channels=32, n_filter=32, filter_size=(2, 2), padding=0, stride=2, use_ternary=False)
        self.bn2 = BatchNorm2d(n_channel=32, momentum=0.1)
        self.relu2 = Relu()

        self.conv3 = Conv2d(in_channels=32, n_filter=64, filter_size=(5, 5), padding=0, stride=1, use_ternary=False)
        ...
        self.conv5 = Conv2d(in_channels=64, n_filter=1024, filter_size=(4, 4), padding=0, stride=1, use_ternary=False)
...
test_acc = test(test_images[:,:,:,:], args.k, test_labels[:,:], network=mynet, batch_size=50, time_step=time_step)
