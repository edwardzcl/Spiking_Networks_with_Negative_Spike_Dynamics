...
plt.ylim(0, 1.0)  
plt.plot(x0, accuracies0, marker='o', ms=8,label='k=0: accuracy=90.26%, time steps=11')
plt.plot(x1, accuracies1, marker='*', ms=8,label='k=1: accuracy=89.99%, time steps=17')
plt.plot(x2, accuracies2, marker='^', ms=8,label='k=2: accuracy=90.25%, time steps=18')
plt.plot(x3, accuracies3, marker='_', ms=8,label='Full-precision ANN: accuracy=90.01%') # need to be updated
...
plt.savefig('scnn_accuracy_fashionmnist.svg',format='svg')