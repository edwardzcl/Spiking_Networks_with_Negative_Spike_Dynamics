...
neuron0 = 32*24*24 + 32*12*12 + 64*8*8 + 64*4*4 + 1024*1*1
neuron1 = neuron0
neuron2 = neuron0  
...
plt.title("Sparsity for FashionMNIST", fontproperties=roman) 
  
plt.show()  

plt.savefig('scnn_spike_neuron_fashionmnist.svg',format='svg')
