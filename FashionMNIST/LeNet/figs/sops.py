...
## the number of MAC of LeNet on FashionMNIST, a multiplication is supposed to be equivalent with two additions in this paper
mac0 = (32*12*12*32*2*2 + 64*8*8*32*5*5 + 64*4*4*64*2*2 + 1024*1*1*64*4*4 + 1024*10)*3
mac1 = mac0
mac2 = mac0
...
plt.title("Computing operations on FashionMNIST", fontproperties=roman)

plt.show()

plt.savefig('scnn_sop_fashionmnist.svg',format='svg')
