...
def VGG_CIFAR10_spike(x_crop, y_, pretrained=False, k=1, end_with='fc1000', n_classes=1000, is_train=True, reuse=False, name=None):
    ...
    with tf.variable_scope("model", reuse=reuse):
         ...
         net = Quant_Conv2d(net, 64, (3, 3), (1, 1), padding='SAME', b_init=None, name='conv00')
