...
plt.ylim(0, 1.0)  
plt.plot(x0, accuracies0, marker='o', ms=8,label='k=0: accuracy=99.29%, time steps=7')
plt.plot(x1, accuracies1, marker='*', ms=8,label='k=1: accuracy=99.32%, time steps=13')
plt.plot(x2, accuracies2, marker='^', ms=8,label='k=2: accuracy=99.28%, time steps=18')
plt.plot(x3, accuracies3, marker='_', ms=8,label='Full-precision ANN: accuracy=99.28%') # need to be updated
...
plt.title("Accuracy versus Speed on MNIST", fontproperties=roman) 
