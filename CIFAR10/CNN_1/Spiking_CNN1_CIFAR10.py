...
class MyNet():
    def __init__(self):
        self.conv0 = Conv2d(in_channels=3, n_filter=96, filter_size=(3, 3), padding=1, stride=1, use_ternary=False)   
        self.bn0 = BatchNorm2d(n_channel=96, momentum=0.1)
        self.relu0 = Relu()

        self.conv1 = Conv2d(in_channels=96, n_filter=256, filter_size=(3, 3), padding=1, stride=1, use_ternary=False)   
        ...
        self.conv3 = Conv2d(in_channels=256, n_filter=384, filter_size=(3, 3), padding=1, stride=1, use_ternary=False)
        self.bn3 = BatchNorm2d(n_channel=384, momentum=0.1)
        self.relu3 = Relu()

        self.conv4 = Conv2d(in_channels=384, n_filter=384, filter_size=(2, 2), padding=0, stride=2, use_ternary=False)
        self.bn4 = BatchNorm2d(n_channel=384, momentum=0.1)
        self.relu4 = Relu()

        self.conv5 = Conv2d(in_channels=384, n_filter=384, filter_size=(3, 3), padding=1, stride=1, use_ternary=False)
        self.bn5 = BatchNorm2d(n_channel=384, momentum=0.1)
        self.relu5 = Relu()

        self.conv6 = Conv2d(in_channels=384, n_filter=256, filter_size=(3, 3), padding=1, stride=1, use_ternary=False)
        self.bn6 = BatchNorm2d(n_channel=256, momentum=0.1)
        self.relu6 = Relu()

        self.conv7 = Conv2d(in_channels=256, n_filter=256, filter_size=(2, 2), padding=0, stride=2, use_ternary=False)
        self.bn7 = BatchNorm2d(n_channel=256, momentum=0.1)
        self.relu7 = Relu()

        self.conv8 = Conv2d(in_channels=256, n_filter=1024, filter_size=(3, 3), padding=0, stride=1, use_ternary=False)
        self.bn8 = BatchNorm2d(n_channel=1024, momentum=0.1)
        self.relu8 = Relu()

        self.conv9 = Conv2d(in_channels=1024, n_filter=1024, filter_size=(1, 1), padding=0, stride=1, use_ternary=False)
        self.bn9 = BatchNorm2d(n_channel=1024, momentum=0.1)
        self.relu9 = Relu()
...
def test(sess, test_images, quant_level, test_labels, network, n_data, batch_size, time_step, noise_ratio):
    ...
    """
    f1 = open('./figs/k2/spike_num.txt', 'w')
    f2 = open('./figs/k2/spike_collect.txt', 'w')
    f3 = open('./figs/k2/sop_num.txt', 'w')
    f4 = open('./figs/k2/accuracy.txt', 'w')
    n_correct = 0
