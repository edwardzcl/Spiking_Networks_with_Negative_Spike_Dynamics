...
plt.ylim(0, 1.0)  
plt.plot(x0, accuracies0, marker='o', ms=8,label='k=0: accuracy=92.64%, time steps=29')
plt.plot(x1, accuracies1, marker='*', ms=8,label='k=1: accuracy=92.77%, time steps=57')
plt.plot(x2, accuracies2, marker='^', ms=8,label='k=2: accuracy=93.10%, time steps=86')
plt.plot(x3, accuracies3, marker='_', ms=8,label='Full-precision ANN: accuracy=92.66%') # need to be updated
...
plt.savefig('scnn1_accuracy_cifar10.svg',format='svg')
