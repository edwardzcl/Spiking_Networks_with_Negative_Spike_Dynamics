...
## the number of MAC of CNN 2 on CIFAR10, a multiplication is supposed to be equivalent with two additions in this paper
mac0 = (256*24*24*128*3*3 + 256*12*12*256*2*2 + 512*12*12*256*3*3 + 512*6*6*512*2*2 + 1024*6*6*512*3*3 + 512*6*6*1024*3*3 + \
512*3*3*512*2*2 + 1024*1*1*512*3*3 + 512*1024 + 512*10)*3
mac1 = mac0
mac2 = mac0
...
plt.savefig('scnn2_sop_cifar10.svg',format='svg')
