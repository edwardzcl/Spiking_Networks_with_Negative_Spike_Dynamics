...
# -*- coding: utf-8 -*-
"""
Training script for VGG-Net (CNN 2) with quantization level k=1 on CIFAR10.
Links
-------
...
resume = False # load model, resume from previous checkpoint after 100 epochs and decay learning rate by 10 times
...
with tf.device('/cpu:0'):
    ...
    def model(x_crop, y_, is_train, reuse):
        ...
        with tf.variable_scope("model", reuse=reuse):
            net = tl.models.CNN2_CIFAR10(x_crop, y_, pretrained=False, k=k, end_with='fc1000', n_classes=10, is_train=is_train, reuse=reuse, name=None)
    ...
    ## train
    n_epoch = 100
    learning_rate = 0.001 #decay it by 10×  after 100 epochs, and set resume = True
    print_freq = 1
