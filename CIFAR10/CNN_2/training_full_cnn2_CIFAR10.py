...
# -*- coding: utf-8 -*-
"""
Training script for full-precision VGG-Net (CNN 2) on CIFAR10.
Links
-------
...
with tf.device('/cpu:0'):
    ...
    def model(x_crop, y_, is_train, reuse):
        ...
        with tf.variable_scope("model", reuse=reuse):
            net = tl.models.CNN2_CIFAR10_FULL(x_crop, y_, pretrained=False, end_with='fc1000', n_classes=10, is_train=is_train, reuse=reuse, name=None)
