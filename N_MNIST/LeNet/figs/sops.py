...
## the number of MAC of LeNet on N-MNIST, a multiplication is supposed to be equivalent with two additions in this paper
mac0 = (12*15*15*12*2*2 + 64*12*12*12*4*4 + 64*6*6*64*2*2 + 64*6*6*10)*3
mac1 = mac0
mac2 = mac0
...
plt.title("Computing operations on N-MNIST", fontproperties=roman) 

plt.show()

plt.savefig('scnn_sop_n_mnist.svg',format='svg')