...
plt.ylim(0, 1.0)  
plt.plot(x0, accuracies0, marker='o', ms=8,label='k=0: accuracy=96.39%, time steps=4')
plt.plot(x1, accuracies1, marker='*', ms=8,label='k=1: accuracy=96.58%, time steps=9')
plt.plot(x2, accuracies2, marker='^', ms=8,label='k=2: accuracy=96.74%, time steps=14')
plt.plot(x3, accuracies3, marker='_', ms=8,label='Full-precision ANN: accuracy=96.43%') # need to be updated
...
plt.savefig('smlp_accuracy_n_mnist.svg',format='svg')
