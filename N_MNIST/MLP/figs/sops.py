...
## the number of MAC of MLP on N-MNIST, a multiplication is supposed to be equivalent with two additions in this paper
...
plt.savefig('smlp_sop_n_mnist.svg',format='svg')
